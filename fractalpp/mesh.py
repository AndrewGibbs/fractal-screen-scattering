...
def koch(prefratal_level, h_max=math.inf, scale = 1, apex_angle = math.pi/3, shift = np.array([0,0]), dash_refine=2):
    K_nodes,elements_pre_np = fractalpp.meshes.koch.build_snowflake(prefratal_level, h_max, scale, apex_angle, shift, dash_refine)
